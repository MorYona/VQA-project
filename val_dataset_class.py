...
class VQA_val(Dataset):
        ...
        def __init__(self,paths):
            ...
            self.train_entries =VQA_val._get_train_entires(self)
            self.train_tokens = VQA_val.tokenize_train(self)
            self.answer_dict = VQA_val.create_answer_dict(self)
            self.question_word_dict = VQA_val.create_question_dict(self)
            self.image_dict = VQA_val.create_image_dict(self)
        ...
        def __getitem__(self, index):
            ...
            if self.tokens[index][1] in self.answer_dict:
